...
Para melhorar a organização, escalabilidade e integração do banco de dados, as principais entidades utilizam identificadores numéricos próprios como chaves primárias.
